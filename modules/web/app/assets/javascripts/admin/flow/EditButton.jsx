...
define(['react', 'coreMixin', 'streamMixin'], function (React, coreMixin, streamMixin) {
    ...
    return React.createClass({
        ...
        handleAdd: function(e) {
            ...
            this.sendCommand(this.props.addr, this.props.route, "edit", {name: name, config: config});
        ...
        render: function () {
            ...
            return (
                <div>
                    ...
                    <div className="modal fade" id="editFlowModal" tabIndex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div className="modal-dialog">
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    <input type="text" className="form-control" ref="name" placeholder="Flow name" value={this.props.info.name}/>
                                    <textarea className="form-control" ref="config" placeholder="Flow config" defaultValue={config}></textarea>
                                </div>
