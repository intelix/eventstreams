...
define(['react', 'core_mixin'], function (React, core_mixin) {
    ...
    return React.createClass({
        ...
        componentName: function() { return "app/content/commons/ResetButton/" + this.props.ckey; },
        ...
        render: function () {
            ...
            return (
                <button type="button" ref="button" className={buttonClasses} onClick={this.handleKill}>reset</button>
            );
