...
define(['react', 'coreMixin', 'streamMixin'], function (React, coreMixin, streamMixin) {
    ...
    return React.createClass({
        ...
        componentName: function() { return "app/content/gates/ReplayButton/" + this.props.route; },
        ...
        handleClick: function (e) {
            if (confirm("Are you sure?")) {
                this.sendCommand(this.props.addr, this.props.route, "replay", {});
            }
        },
        ...
        render: function () {
            ...
            var button =
                <button type="button" ref="button" className={buttonClasses} onClick={this.handleClick}>
                replay
                </button>;
