...
case class ScheduleStorage(ref: ActorRef, index: String, etype: String, id: String, v: JsValue) extends WithID {
...
class ReplayWorkerActor(clientAgent: Agent[Option[ElasticClient]], m: InitiateReplay)
  ...
  override def componentId: String = "Actor.ReplayWorkerActor" // TODO
